...
namespace WebApplication1
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if (checkBookExists())
            {
                Response.Write("<script>alert('Book Already Exists, try some with other book ID');</script>");
            }
            else
            {
                addNewBook();
        ...
        void addNewBook()
        {
            try
            {
                ...
                {
                    genres = genres + ListBox1.Items[i] + ","; // It displays Adventure, Action, there will
                }                                              // be an extra , to get rid of this we use.
