...
namespace WebApplication1
{
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {  
                // We are creating this because for every 20 mins the session gets expired if you are not doing anything in webpage. 
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                if(result > 0)
                {
                    Response.Write("<script>alert('Your Details Are Successfully Updated');</script>");
                    getUserPersonalDetails();
                    getUserBookData();
                }
                else
